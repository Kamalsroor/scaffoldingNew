...
<head>
    ...
    <!-- <link rel="stylesheet" type="text/css" href="../files/assets/css/bootstrap_rtl.css"> -->
    ...
    <link rel="stylesheet" type="text/css" href="{{asset('adminty')}}\assets\pages\prism\prism.css">
    <!-- Style.css -->
                            ...
                            <li class="header-notification">
                                <div class="dropdown-primary dropdown">
                                    ...
                                    <ul class="show-notification notification-view dropdown-menu" data-dropdown-in="fadeIn" data-dropdown-out="fadeOut">
                                        ...
                                        <li>
                                            <div class="media">
                                                <img class="d-flex align-self-center img-radius" src="{{asset('adminty')}}\assets\images\avatar-4.jpg" alt="Generic placeholder image">
                                        ...
                                        <li>
                                            <div class="media">
                                                <img class="d-flex align-self-center img-radius" src="{{asset('adminty')}}\assets\images\avatar-3.jpg" alt="Generic placeholder image">
                                                <div class="media-body">
                                    ...
                                    <ul class="show-notification profile-notification dropdown-menu" data-dropdown-in="fadeIn" data-dropdown-out="fadeOut">
                                        ...
                                        <li>
                                            <a href="{{ auth()->user()->dashboardProfile() }}">
                                                <i class="feather icon-user"></i> @lang('users.profile')
                                            </a>
                                        </li>
                                        <li>
                                        ...
                                        <li>
                                            <a href="auth-normal-sign-in.htm"  onclick="event.preventDefault();document.getElementById('logoutForm').submit()">
                                                <i class="feather icon-log-out"></i> @lang('dashboard.auth.logout')
                                            </a>
                            ...
                            <div class="main-friend-list">
                                <div class="media userlist-box" data-id="1" data-status="online" data-username="Josephin Doe" data-toggle="tooltip" data-placement="left" title="Josephin Doe">
                                    <a class="media-left" href="#!">
                                        <img class="media-object img-radius img-radius" src="{{asset('adminty')}}\assets\images\avatar-3.jpg" alt="Generic placeholder image ">
                                ...
                                <div class="media userlist-box" data-id="2" data-status="online" data-username="Lary Doe" data-toggle="tooltip" data-placement="left" title="Lary Doe">
                                    <a class="media-left" href="#!">
                                        <img class="media-object img-radius" src="{{asset('adminty')}}\assets\images\avatar-2.jpg" alt="Generic placeholder image">
                                        <div class="live-status bg-success"></div>
                                    </a>
                                    <div class="media-body">
                                ...
                                <div class="media userlist-box" data-id="3" data-status="online" data-username="Alice" data-toggle="tooltip" data-placement="left" title="Alice">
                                    <a class="media-left" href="#!">
                                        <img class="media-object img-radius" src="{{asset('adminty')}}\assets\images\avatar-4.jpg" alt="Generic placeholder image">
                                        <div class="live-status bg-success"></div>
                                    </a>
                                    <div class="media-body">
                                ...
                                <div class="media userlist-box" data-id="4" data-status="online" data-username="Alia" data-toggle="tooltip" data-placement="left" title="Alia">
                                    <a class="media-left" href="#!">
                                        <img class="media-object img-radius" src="{{asset('adminty')}}\assets\images\avatar-3.jpg" alt="Generic placeholder image">
                                        <div class="live-status bg-success"></div>
                                    </a>
                                    <div class="media-body">
            ...
            <div class="showChat_inner">
                ...
                <div class="media chat-messages">
                    <a class="media-left photo-table" href="#!">
                        <img class="media-object img-radius img-radius m-t-5" src="{{asset('adminty')}}\assets\images\avatar-3.jpg" alt="Generic placeholder image">
                    </a>
                ...
                <div class="media chat-messages">
                    ...
                    <div class="media-right photo-table">
                        <a href="#!">
                            <img class="media-object img-radius img-radius m-t-5" src="{{asset('adminty')}}\assets\images\avatar-4.jpg" alt="Generic placeholder image">
                        </a>
                    </div>
                </div>
                    ...
                    <nav class="pcoded-navbar">
                        <div class="pcoded-inner-navbar main-menu">
                            ...
                            <ul class="pcoded-item pcoded-left-item">
                                ...
                                <li class="">
                                    <a href="{{asset('adminty')}}\extra-pages\landingpage\index.htm" target="_blank">
                                ...
                                <li class="pcoded-hasmenu ">
                                    ...
                                    <ul class="pcoded-submenu">
                                        ...
                                        <li class="pcoded-hasmenu ">
                                            ...
                                            <ul class="pcoded-submenu">
                                                <li class="">
                                                    <a href="{{asset('adminty')}}\extra-pages\email-templates\email-welcome.htm">
                                                        <span class="pcoded-mtext">Welcome Email</span>
                                                    </a>
                                                </li>
                                                <li class="">
                                                    <a href="{{asset('adminty')}}\extra-pages\email-templates\email-password.htm">
                                                        <span class="pcoded-mtext">Reset Password</span>
                                                    </a>
                                                </li>
                                                <li class="">
                                                    <a href="{{asset('adminty')}}\extra-pages\email-templates\email-newsletter.htm">
                                                        <span class="pcoded-mtext">Newsletter Email</span>
                                                    </a>
                                                </li>
                                                <li class="">
                                                    <a href="{{asset('adminty')}}\extra-pages\email-templates\email-launch.htm">
                                                        <span class="pcoded-mtext">App Launch</span>
                                                    </a>
                                                </li>
                                                <li class="">
                                                    <a href="{{asset('adminty')}}\extra-pages\email-templates\email-activation.htm">
                                            ...
                                            <div class="col-lg-4">
                                                <div class="page-header-breadcrumb">
                                                    <ul class="breadcrumb-title">
                                                        ...
                                                        <li class="breadcrumb-item"><a href="#!">RTL</a>
                                                        </li>
                                                    </ul>
                                                </div>
                                            </div>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12">
                                                ...
                                                <div class="card">
                                                    ...
                                                    <div class="card-block">
                                                        <span>To use Compact Menu for your project add <code><strong>verticalMenuplacement: 'right',</strong></code> class in js.</span>
                                                    </div>
                                                </div>
                                                <div class="card">
                                                    <div class="card-header">
                                                    ...
                                                    <div class="card-block">
                                                        <p>Use the following code to use <strong>RTL Menu</strong></p>
...
<![endif]-->
    ...
    <script type="text/javascript" src="{{asset('adminty')}}\assets\pages\prism\custom-prism.js"></script>
    <!-- i18next.min.js -->
    ...
    <script src="{{asset('adminty')}}\assets\js\menu\menu-rtl.js"></script>
